...
async function main() {
  ...
  const permissions = await prisma.permission.createMany({
    data: [
      ...
      { name: "Cancel-Adjustment", moduleId: 25 },
      { name: "Expense-Report", moduleId: 25 },
      { name: "Cancel-Expense", moduleId: 25 },
      { name: "Income-Report", moduleId: 25 },
      { name: "Cancel-Income", moduleId: 25 },
      { name: "Stock-Request-Report", moduleId: 25 },
      { name: "Cancel-Stock-Request", moduleId: 25 },
      { name: "Stock-Return-Report", moduleId: 25 },
      { name: "Cancel-Stock-Return", moduleId: 25 },
      { name: "Stock-Transfer-Report", moduleId: 25 },
      { name: "Cancel-Stock-Transfer", moduleId: 25 },
    ],
  });
